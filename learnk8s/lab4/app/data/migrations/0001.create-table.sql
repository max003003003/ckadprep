...
INSERT INTO quotes VALUES ('Do not stop when you are tired. STOP when you are DONE. --Unknown',4),
('Every great story on the planet happened when someone decided not to give up, but kept going no matter what. -- Spryte Loriano',3),
 ...
 ('The index of the last item returned. When paginating through results',6),
